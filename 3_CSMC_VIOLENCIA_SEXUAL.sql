-- ================================================================
--  Ficha Seguimiento · VIOLENCIA_SEXUAL (T742 y Y05)
--  Base: BDHIS_MINSA  |  Destino: dbo.ficha_VIOLENCIA_SEXUAL_csmc25
--  Período: 2025
-- ================================================================
...
IF OBJECT_ID('dbo.ficha_VIOLENCIA_SEXUAL_csmc25', 'U') IS NOT NULL
    DROP TABLE dbo.ficha_VIOLENCIA_SEXUAL_csmc25;
...
INTO  dbo.ficha_VIOLENCIA_SEXUAL_csmc25
FROM  Dx D
LEFT JOIN Act     A  ON D.DNI = A.DNI
LEFT JOIN Acogida AC ON D.DNI = AC.DNI
WHERE D.RankDx = 1;

SELECT * FROM dbo.ficha_VIOLENCIA_SEXUAL_csmc25
