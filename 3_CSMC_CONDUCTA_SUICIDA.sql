--================================================================
--  Ficha Seguimiento · Tratamiento ambulatorio de personas con conducta_suicida (X60 al X84)
--  Base: BDHIS_MINSA  |  Destino: dbo.ficha_conducta_suicida_csmc25
--  Período: 2025 
-- ================================================================
...
IF OBJECT_ID('dbo.ficha_conducta_suicida_csmc25', 'U') IS NOT NULL
    DROP TABLE dbo.ficha_conducta_suicida_csmc25;
...
Act AS (
    SELECT B.DNI,
        ...
        -- Consulta Médica CS (sesiones 1-2)
        MAX(CASE WHEN B.Codigo_Item IN ('99215') AND B.Tipo_Diagnostico = 'D' AND B.Id_Correlativo_Item IN (2,3,4,5,6) AND B.Valor_Lab = '1' THEN B.Fecha_Atencion END) AS Fec_CS1,
        MAX(CASE WHEN B.Codigo_Item IN ('99215') AND B.Tipo_Diagnostico = 'D' AND B.Id_Correlativo_Item IN (2,3,4,5,6) AND B.Valor_Lab = '2' THEN B.Fecha_Atencion END) AS Fec_CS2,
        ...
        MAX(CASE WHEN B.Codigo_Item IN ('90806','90834','90860') AND B.Tipo_Diagnostico = 'D' AND B.Id_Correlativo_Item IN (2,3,4,5,6) AND B.Valor_Lab = '6' THEN B.Fecha_Atencion END) AS Fec_PS6,
		 ...
		 -- intervención Familiar IG (sesión 1-2)
...
INTO  dbo.ficha_conducta_suicida_csmc25
FROM  Dx D
LEFT JOIN Act     A  ON D.DNI = A.DNI
LEFT JOIN Acogida AC ON D.DNI = AC.DNI
WHERE D.RankDx = 1;

SELECT * FROM dbo.ficha_conducta_suicida_csmc25
